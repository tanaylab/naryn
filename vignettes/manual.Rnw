...
Once \texttt{emr\_db.init} is successfully called a few auxiliary variables are added to R global environment (Python: to module's dictionary). Please refer the documentation of this function.
