...
```r
emr_filter.create("steroids_filter", "steroids_track", time.shift=c(-days(7), 0))
emr_vtrack.create("annual_glucose",
  src = "glucose_track", func = "quantile",
...
```r
emr_filter.create("filterX", "drugX", time.shift = c(days(7), 0))
emr_filter.create("filterY", "drugY", time.shift = c(days(7), 0))
emr_filter.create("filterZ", "drugZ", time.shift = c(days(7), 0))
