test_that("filter works", {
    ...
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = T, filter = "f1"))
})
...
test_that("filter works with time shift", {
    ...
    expect_regression(emr_extract("track7", keepref = T, filter = "f1"))
})
...
test_that("use a track as filter", {
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = T, filter = "!track1"))
})

test_that("use multiple tracks as filter", {
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = T, filter = "!track0 | !track1"))
})
...
test_that("filter works", {
    ...
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = T, filter = "f1 & track1"))
})

test_that("filter works", {
    EMR_FILTERS <<- list()
    emr_filter.create("f1", "track0", keepref = T)
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = F, filter = "(f1 | track1) & !track5"))
})

test_that("filter works", {
    EMR_FILTERS <<- list()
    emr_filter.create("f1", "track0", keepref = T)
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = T, filter = "(f1 | track1) & !track5"))
})

test_that("filter works", {
    EMR_FILTERS <<- list()
    emr_filter.create("f1", "track0_sparse", keepref = T)
    expect_regression(emr_extract("track2_sparse", stime = 10, etime = 1000, keepref = T, filter = "(f1 | track1) & !track5_sparse"))
})
...
test_that("filter works", {
    ...
    expect_regression(emr_extract("2 * track2", stime = 10, etime = 1000, keepref = T, filter = "i1"))
})

test_that("filter works", {
    i1 <- emr_extract("track1_sparse", keepref = F)
    expect_regression(emr_extract("track2_sparse", stime = 10, etime = 1000, keepref = T, filter = "i1"))
})
...
test_that("filter works", {
    i1 <- emr_extract("track1", keepref = F)
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = T, filter = "!i1"))
})
...
test_that("filter works", {
    ...
    i1 <- emr_extract("track1", keepref = F)
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = T, filter = "i0 & i1"))
})
...
test_that("filter works", {
    ...
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = T, filter = "f1 & i1"))
})
...
test_that("filter works", {
    ...
    i1 <- emr_extract("track1", keepref = F)
    emr_filter.create("f1", i0, keepref = T)
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = F, filter = "(f1 | i1) & !track5"))
})
...
test_that("filter works", {
    ...
    i1 <- emr_extract("track1", keepref = F)
    emr_filter.create("f1", i0, keepref = T)
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = T, filter = "(f1 | i1) & !track5"))
})
...
test_that("filter works", {
    ...
    i1 <- emr_extract("track1", keepref = F)
    emr_filter.create("f1", "track0_sparse", keepref = T)
    expect_regression(emr_extract("track2_sparse", stime = 10, etime = 1000, keepref = T, filter = "(f1 | i1) & !track5_sparse"))
})
...
test_that("filter works", {
    ...
    i1 <- emr_screen("track1>990", stime = 500, etime = 2000)
    i1 <- data.frame(id = unique(i1$id))
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = F, filter = "(i0 | i1) & !track5"))
})
...
test_that("filter works", {
    ...
    expect_regression(emr_extract("track2", stime = 10, etime = 2000, keepref = T, filter = "t"))
})
...
test_that("filter works", {
    expect_regression(emr_extract("track1", iterator = 1, keepref = F, stime = 10, etime = 15))
})

test_that("beat iterator warning", {
    expect_warning(emr_extract("track1", iterator = 1, keepref = T, stime = 10, etime = 15))
    expect_warning(expect_regression(emr_extract("track1", iterator = 1, keepref = T, stime = 10, etime = 15)))
})
...
test_that("filter works", {
    ...
    emr_filter.create("f1", "track0", keepref = F, time.shift = c(10, 50))
    emr_filter.create("f2", "track3", keepref = T)
    expect_regression(emr_extract("track1", iterator = 1, stime = 20, etime = 5000, keepref = T, filter = "f1 & f2"))
})
...
test_that("filter works", {
    expect_regression(emr_extract("track1", iterator = 2, keepref = F, stime = 10, etime = 15))
})

test_that("filter works", {
    expect_warning(expect_regression(emr_extract("track1", iterator = 2, keepref = T, stime = 10, etime = 15)))
})
...
test_that("filter works", {
    ...
    emr_filter.create("f1", "track0", keepref = F, time.shift = c(10, 50))
    emr_filter.create("f2", "track3", keepref = T)
    expect_regression(emr_extract("track1", iterator = 2, stime = 20, etime = 5000, keepref = T, filter = "f1 & f2"))
})
...
test_that("filter works", {
    set.seed(0)
    expect_regression(emr_extract("track1", iterator = list(2, data.frame(id = sample(1:1000, 500), time = sample(1:100, 500, replace = T))), stime = 10, etime = 15))
})
