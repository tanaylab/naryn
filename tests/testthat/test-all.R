...
#     emr_track.attr.set('track9', 'var1', 'val3')
#     emr_track.attr.set('track9', 'var2', '')
...
#     emr_track.attr.set('track9', 'var1', 'val3')
#     emr_track.attr.set('track9', 'var2', '')
#     emr_track.attr.export(c('track1', 'track9'))
# })
...
#     emr_track.attr.set('track9', 'var1', 'val3')
#     emr_track.attr.set('track9', 'var2', '')
#     emr_track.attr.export(c('track1', 'track9'), c('var2', 'var3'))
# })
...
# test_that("test", emr_track.ls())

# test_that("test", emr_track.ls("*sparse"))
...
#     emr_track.attr.set('track1', 'var3', 'val3')
#     emr_track.attr.set('track2', 'var2', 'baba')
#     emr_track.attr.set('track9', 'var1', 'kuku')
#     emr_track.attr.set('track9', 'var2', '')
#     emr_track.ls(var1='kuku')
# })
...
#     emr_track.attr.set('track9', 'var1', 'val3')
#     emr_track.attr.set('track9', 'var2', '')
#     emr_track.ls(var1='val*', var2='')
# })

# test_that("test", emr_track.global.ls())

# test_that("test", emr_track.user.ls())
