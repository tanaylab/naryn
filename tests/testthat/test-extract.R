...
test_that("emr_extract #1", {
    ...
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = F), "extract.15")
    ...
    expect_regression(emr_extract(c("track1", "track2"), iterator = "track0", tidy = T, keepref = T), "extract.17")
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = F), "extract.18")
    expect_error(emr_extract(c("track1", "track2"), stime = 10, etime = 1000))
    expect_regression(emr_extract(c("track1", "track2"), stime = 10, etime = 1000, iterator = 100), "extract.19")
    expect_regression(emr_extract(c("track1", "track2"), iterator = "track0", tidy = T, keepref = T), "extract.20")
})

test_that("emr_extract with names", {
    expect_regression(emr_extract(c("track1", "track2"), iterator = "track0", tidy = T, keepref = T, names = c("t1", "t2")), "extract.21")
    expect_regression(emr_extract(c("track1", "track2"), iterator = "track0", keepref = T, names = c("t1", "t2")), "extract.22")
})

test_that("emr_screen works", {
    i <- emr_screen("track1>990", stime = 500, etime = 2000)
    expect_regression(i, "extract.23")
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = F, iterator = i), "extract.24")
})

test_that("emr_screen works without ref", {
    i <- emr_screen("track1>990", stime = 500, etime = 2000)
    i$ref <- NULL
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = F, iterator = i), "extract.25")
})

test_that("emr_screen works with keepref=T", {
    i <- emr_screen("track1>990", stime = 500, etime = 2000)
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = T, iterator = i), "extract.26")
})

test_that("emr_screen works with keepref=F", {
    i <- emr_screen("track1>990", stime = 5000, etime = 20000)
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = F, iterator = i), "extract.27")
})
...
test_that("emr_extract works with dataframe iterator", {
    ...
    expect_regression(emr_extract("track2", stime = 10, etime = 11, keepref = T, iterator = i), "extract.28")
})

test_that("emr_extract works with dataframe iterator keepref=F", {
    i <- emr_screen("track1>990", stime = 500, etime = 2000)
    i <- data.frame(id = unique(i$id))
    expect_regression(emr_extract("track2", stime = 10, etime = 20, keepref = F, iterator = i), "extract.29")
})

test_that("emr_extract works with dataframe stime and etime iterator", {
    t <- data.frame(stime = c(5, 50), etime = c(10, 52))
    expect_regression(emr_extract("track2", stime = 10, etime = 20, keepref = F, iterator = t), "extract.30")
    expect_regression(emr_extract("track2", stime = 10, etime = 20, keepref = T, iterator = t), "extract.31")
})

test_that("emr_extract #2", {
    expect_regression(emr_extract("track2", stime = 10, etime = 1000, keepref = T), "extract.32")
    expect_regression(emr_extract("track2_sparse", stime = 10, etime = 1000, keepref = F), "extract.33")
    expect_regression(emr_extract("track2_sparse", stime = 10, etime = 1000, keepref = T), "extract.34")
})

test_that("emr_extract with track expression", {
    expect_regression(emr_extract("2 * track2", stime = 10, etime = 1000, keepref = T, filter = "track1"), "extract.35")
})

test_that("emr_extract with filter", {
    expect_regression(emr_extract("track2_sparse", stime = 10, etime = 1000, keepref = T, filter = "track1_sparse"), "extract.36")
})
