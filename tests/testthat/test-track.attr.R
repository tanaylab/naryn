...
test_that("emr_track.attr.set works for multiple tracks", {
    ...
    expect_equal(
        ...
        structure(list(track = c("track1", "track1", "track1", "track7",
"track7"), attr = c("var1", "var2", "var3", "var1", "var2"),
    value = c("val1", "val2", "val3", "val3", "")), row.names = c(NA,
5L), class = "data.frame")
    )
})
...
test_that("emr_track.attr.set works for multiple tracks and vars", {
    ...
    expect_equal(
        ...
        structure(list(track = c("track1", "track1", "track7"), attr = c("var2",
"var3", "var2"), value = c("val2", "val3", "")), row.names = c(NA,
3L), class = "data.frame")
    )
})
...
test_that("emr_track.attr.set works by attributes", {
    ...
    expect_equal(
        ...
        structure(list(track = c("track1", "track1", "track2", "track7"
), attr = c("var2", "var3", "var2", "var2"), value = c("val2",
"val3", "baba", "")), row.names = c(NA, 4L), class = "data.frame")
    )
})
